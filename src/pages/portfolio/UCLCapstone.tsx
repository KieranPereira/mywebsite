      ...
      <div className="flex flex-col md:flex-row">
        ...
        <aside className="hidden md:block fixed left-0 top-0 w-1/5 h-screen bg-gradient-to-b from-gray-900 to-gray-700 p-4 shadow-lg z-20 pt-16 overflow-y-auto">
          <nav className="space-y-4">
            ...
            <a href="#full-report" className="block text-white font-semibold hover:text-gray-300 transition-colors">Full Report Preview</a>
          </nav>
        </aside>
        ...
        <Section className="bg-gray-50 text-gray-900" sectionId="introduction" sectionTitle="1.0 Introduction">
          <div className="p-6">
            ...
            <Image
                src="/UCLCapstone/figure1.png" // Update with the correct image path
              ...
              />
              <p className="text-center text-sm text-gray-600 mt-2">Figure 1: UK Driving Statistics for 2022</p>
            </div>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Methodology Section with Collapsible Subsections */}
            ...
            <div className="p-6 space-y-8">
              ...
              <details className="mb-4">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The global distribution of images is clearly illustrated in Figure 8 below.
                  </p>
                  <Image
                    src="/uclCapstone/figure8.jpg"
              ...
              <details className="mb-4">
                ...
                <div className="mt-2">
                  <p className="text-gray-700 leading-relaxed">
                    Post-cropping analysis revealed the presence of irrelevant background elements like sky, trees, and roads. To reduce this noise, a background elimination method using RGB thresholding was applied. The process involved eroding, dilating, and Gaussian blurring to enhance edge boundaries, followed by defining colour thresholds for red, blue, yellow, black, and white. Figure 16 demonstrates the effect of this method.
                  </p>
                  <Image
                    src="/uclCapstone/figure16.jpg"
              ...
              <details className="mb-4">
                ...
                <div className="mt-2">
                  <p className="text-gray-700 leading-relaxed">
                    YOLOv5 provides 27 tuneable hyperparameters, which are critical to model performance. Manual tuning was impractical, so a genetic algorithm was implemented to optimise these parameters. The process involved selecting an initial set of hyperparameters, generating 10 variations per generation, training each for 10 epochs, and averaging the top 5 performers to form a new parent set. This iterative method continued until convergence, ultimately improving the mAP to 83.43%. Figure 17 visualises this hyperparameter evolution process.
                  </p>
                  <Image
                    src="/uclCapstone/figure17.jpg"
          ...
          {/* Full Research Report Preview */}
          <Section className="bg-white text-gray-900" sectionId="full-report" sectionTitle="Full Research Report Preview">
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                Want a more detailed look? Here is a preview of my full research report:
              </p>
